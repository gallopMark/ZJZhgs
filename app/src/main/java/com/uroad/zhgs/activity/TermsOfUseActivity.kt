 ...
 * 使用条款
 */
class TermsOfUseActivity : BaseHtmlActivity() {

    override fun setUp(savedInstanceState: Bundle?) {
        super.setUp(savedInstanceState)
        withTitle(resources.getString(R.string.aboutUs_termsOfUser))
    }

    override fun initData() {
        doRequest(WebApiService.NEWS_BY_TYPE, WebApiService.newsByTypeParams(NewsType.TERMS.code), object : HttpRequestCallback<String>() {
