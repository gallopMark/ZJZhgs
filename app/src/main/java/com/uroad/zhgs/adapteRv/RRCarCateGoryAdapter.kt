 ...
 */
class RRCarCateGoryAdapter(context: Context, mDatas: MutableList<RescueRequestMDL.Type>)
    : BaseArrayRecyclerAdapter<RescueRequestMDL.Type>(context, mDatas) {
    private var onItemSelectedListener: OnItemSelectedListener? = null
    private var selectIndex = 0

    override fun onBindHoder(holder: RecyclerHolder, t: RescueRequestMDL.Type, position: Int) {
