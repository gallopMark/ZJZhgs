 ...
 * 救援请求 （所在方向）
 */
class RRDirectionAdapter(context: Context, mDatas: MutableList<RescueRequestMDL.Direction>)
    : BaseArrayRecyclerAdapter<RescueRequestMDL.Direction>(context, mDatas) {
    private var onItemSelectedListener: OnItemSelectedListener? = null
    private var selectIndex = 0
    override fun onBindHoder(holder: RecyclerHolder, t: RescueRequestMDL.Direction, position: Int) {
        val tv = holder.obtainView<TextView>(R.id.tv)
        tv.text = t.directionname
