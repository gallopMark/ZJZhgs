 ...
 */
class ScenicDialog(private val context: Activity, private val dataMDL: ScenicMDL)
    ...
    private fun initView() {
        window?.let { window ->
            val contentView = LayoutInflater.from(context).inflate(R.layout.dialog_scenic, LinearLayout(context), false)
            ...
            ivIcon.setImageResource(R.mipmap.ic_menu_scenic_p)
    ...
    interface OnButtonClickListener {
        fun onDetail(dataMDL: ScenicMDL)
        fun onNavigation(dataMDL: ScenicMDL)
    }
}