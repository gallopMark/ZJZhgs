...
public class NaviActivity extends Activity implements AMapNaviListener,
	...
	public static final int NaviType_GPS = 1;
	public static final int NaviType_EMULATOR = 2;
	int type = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		double startLat = getIntent().getExtras().getDouble("startLat", 0);
		double startLon = getIntent().getExtras().getDouble("startLon", 0);
		double endLat = getIntent().getExtras().getDouble("endLat", 0);
		double endLon = getIntent().getExtras().getDouble("endLon", 0);
		NaviLatLng start = new NaviLatLng(startLat, startLon);
	...
	public void onCalculateRouteSuccess(int[] ints) {
		// 路线计算成功
		if (type == NaviType_GPS) {
			mAMapNavi.startNavi(NaviType.GPS);
		} else if (type == NaviType_EMULATOR) {
	...
	public void onCalculateRouteFailure(int errorInfo) {
		// 路线计算失败
		Toast.makeText(this, "errorInfo:" + errorInfo, Toast.LENGTH_SHORT)
				.show();
	}
