...
import com.uroad.locmap.offlinemap.OfflineDownloadedAdapter;
import com.uroad.locmap.offlinemap.OfflineListAdapter;
import com.uroad.locmap.offlinemap.OfflinePagerAdapter;
import com.uroad.locmap.util.OffLineMapUtils;
...
public class OffLineMapActivity extends Activity implements
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case SHOW_MSG:
				...
				ToastUtil.showShortToast(OffLineMapActivity.this,
						(String) msg.obj);
				break;
	...
	public void onCheckUpdate(boolean hasNew, String name) {
		...
		message.obj = name + " : " + (hasNew ? "有新版本" : "已是最新");
	...
	public void onRemove(boolean success, String name, String describe) {
		...
		Message message = new Message();
		message.what = SHOW_MSG;
		message.obj = "删除 " + name + " : " + (success ? "成功" : "失败");
		handler.sendMessage(message);
	...
	public void onClick(View v) {
		if (v.equals(mDownloadText)) {
			...
			mDownloadText.setTextColor(getResources().getColor(R.color.white));
			mDownloadedText
			...
			mDownloadText.setTextColor(getResources().getColor(R.color.black));
			mDownloadedText
